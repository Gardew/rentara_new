    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="w-full flex justify-between items-center">
                ...
                >
                    <ArrowLeft className="w-4 h-4 mr-1"/> {t('dataTable.previous')}
                </Button>

                <p className="text-muted-foreground text-sm white-space-nowrap md:text-md">
                    {t('dataTable.pageOf', { page, count: table.getPageCount() })}
                </p>
                ...
                >
                    {t('dataTable.next')} <ArrowRight className="w-4 h-4 ml-1" />
                </Button>
            </div>
        </div>
    )
