...
const Navbar = ({children}) => {
    ...
    const items = useMemo(() => ([
        ...
        {
            title: t('navbar.properties'),
            url: '/properties',
            icon: <Building2/>,
            section: "MENU"
        },
        {
            title: t('navbar.rentals'),
            url: '/rentals',
            icon: <BuildingIcon/>,
            section: "MENU"
        },
        {
            title: t('navbar.financials'),
            url: '/financials',
            icon: <CircleDollarSignIcon/>,
            section: "MENU"
        },
        {
            title: t('navbar.tenants'),
            url: '/tenants',
            icon: <UserIcon/>,
            section: "MENU"
        },
        ...
        return (
            ...
            >
                <div>
                    ...
                    />
                        <p className="hidden md:flex text-card-foreground ">{t('navbar.appName')}</p>
                    </h3>
                    <nav
