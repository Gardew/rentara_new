...
const TenantCreation = () => {
    ...
    const leaseOptions = [
        {
            title: t('tenantCreation.leaseOptions.new.title'),
            description: t('tenantCreation.leaseOptions.new.desc'),
            icon: <Plus className="w-6 h-6" />,
            value: "new"
        },
        {
            title: t('tenantCreation.leaseOptions.existing.title'),
            description: t('tenantCreation.leaseOptions.existing.desc'),
    ...
    const tenantForm = useForm(({
		...
		{
			title: t('tenantCreation.steps.information'),
			status: "incomplete",
		},
		{
			title: t('tenantCreation.steps.lease'),
			status: "incomplete",
		},
		{
			title: t('tenantCreation.steps.unit'),
			status: "incomplete",
		},
		{
			title: t('tenantCreation.steps.confirmation'),
			status: "incomplete",
		}
	])
        ...
        <div className="flex flex-col gap-2 relative mb-16">
                    ...
                    <form  onSubmit={tenantForm.handleSubmit(onSubmit)} className="flex flex-col flex-wrap gap-4">
                        ...
                        <Card>
                            <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                                							<Info/>
							{t('tenantCreation.sections.information')}
                            </CardHeader>
                            <CardContent className="flex flex-col gap-4">
                                ...
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('tenantCreation.fields.firstName')} *</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('tenantCreation.fields.lastName')} *</FormLabel>
                                                <FormControl>
                                ...
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('tenantCreation.fields.email')}</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('tenantCreation.fields.phone')}</FormLabel>
                                                <FormControl>
                                ...
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('tenantCreation.fields.occupation')}</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('tenantCreation.fields.income')}</FormLabel>
                                                <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem  >
                                            							<FormLabel>{t('tenantCreation.fields.civilStatus')}</FormLabel>
                ...
                <Form {...tenantForm}>
                    <form
                        ...
                        <Card>
                            <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                                							<ListIcon/>
							{t('tenantCreation.sections.lease')}
                            </CardHeader>
                                        ...
                                        <>
                                            ...
                                            <FormGroup useFlex  >
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem  >
                                                            							<FormLabel>{t('tenantCreation.fields.unit')} *</FormLabel>
                                                            <FormControl>
                                                                {
                                                                    leaseOption === "new" ? (
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem  >
                                                            							<FormLabel>{t('tenantCreation.fields.startDate')} *</FormLabel>
                                                            <FormControl>
                                                                {
                                                                    leaseOption === "new" ? (
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem  >
                                                            							<FormLabel>{t('tenantCreation.fields.endDate')} *</FormLabel>
                                                            <FormControl>
                                                                {
                                                                    leaseOption === "new" ? (
                                                                        <Input type="date"  {...field} />
                                            ...
                                            <FormGroup useFlex>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem  >
                                                            							<FormLabel>{t('tenantCreation.fields.rentalPrice')}</FormLabel>
                                                            <FormControl>
                                                                {
                                                                    leaseOption === "new" ? (
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem>
                                                            							<FormLabel>{t('tenantCreation.fields.paymentFrequency')} *</FormLabel>
                                                            {
                                                                leaseOption === "new" ? (
                                                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                                        <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem  >
                                                            							<FormLabel>{t('tenantCreation.fields.leaseStatus')}</FormLabel>
                                            ...
                                            <FormGroup>
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem  >
                                                            							<FormLabel>{t('tenantCreation.fields.notes')}</FormLabel>
                                                            <FormControl>
                                                                {
                                                                    leaseOption === "new" ? (
                ...
                <Form {...tenantForm}>
                    <form className="flex flex-col flex-wrap gap-4 overflow-auto">
                        ...
                        <Card>
                            <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                                							<UserSearch/>
							{t('tenantCreation.sections.unit')}
                                    <TooltipProvider>
                                        <Tooltip>
            ...
            <div
                ...
                <Card>
                    <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                        						<BadgeCheck/>
						{t('tenantCreation.sections.confirmation')}
                    </CardHeader>
                    <CardContent className="p-6 flex flex-col gap-4">
