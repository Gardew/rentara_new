...
const Financials = (props) => {
    ...
    const tabs = [
        {
            title: t('financials.tabs.payments'),
            content: (
        ...
        {
            title: t('financials.tabs.expenses'),
        ...
        <>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-row flex-wrap gap-4">
                    <InfoCard title={t('financials.cards.rentDue')} number={moneyParser(rentDue)}  />
                    <InfoCard title={t('financials.cards.rentPaid')} number={moneyParser(rentPaid)}  />
                    <InfoCard title={t('financials.cards.activeLeases')} number={activeLeases}   />
                </div>
