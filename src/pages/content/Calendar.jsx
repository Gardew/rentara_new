        ...
        return (
            <div>
                ...
                <div className="flex flex-col gap-2 text-muted-foreground">
                    ...
                    {eventsInRange.length === 0 && <div>{t('calendar.noEvents')}</div>}
                </div>
                </div>
        )
    }
                ...
                <div className="flex flex-col gap-2 w-fit">
                    ...
                    <Accordion type="multiple" collapsible={true}>
                        <AccordionItem value="upcoming">
                            <AccordionTrigger>{t('calendar.upcoming')}</AccordionTrigger>
                            <AccordionContent>
                                {t('calendar.upcomingLead')}
                                <UpcomingEvents/>
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="categories" open>
                            <AccordionTrigger>{t('calendar.categories')}</AccordionTrigger>
