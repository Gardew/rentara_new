...
const PropertyCreation = () => {
    ...
    const unitMultiplicityOptions = [
        {
            title: t('propertyCreation.unitMultiplicity.single.title'),
            description: t('propertyCreation.unitMultiplicity.single.desc'),
            icon: <Home className="w-6 h-6" />,
            value: "single"
        },
        {
            title: t('propertyCreation.unitMultiplicity.multi.title'),
            description: t('propertyCreation.unitMultiplicity.multi.desc'),
    ...
    const propertyForm = useForm(({
		...
		{
			title: t('propertyCreation.steps.information'),
			status: "incomplete"
		},
		{
			title: t('propertyCreation.steps.units'),
			status: "incomplete"
		},
		{
			title: t('propertyCreation.steps.confirmation'),
			status: "incomplete"
		}
	])
        ...
        <div className="flex flex-col gap-2 relative mb-16">
                    ...
                    <form onSubmit={propertyForm.handleSubmit(onSubmit)} className="flex flex-col flex-wrap gap-4">
                        ...
                        <Card>
                            <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                                <ListIcon/>
                                							{t('propertyCreation.sections.unitType')}
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                                							<Info/>
							{t('propertyCreation.sections.information')}
                            </CardHeader>
                            <CardContent>
                                ...
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem  >
                                                							<FormLabel>{t('propertyCreation.fields.title')} *</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                							<FormLabel>{t('propertyCreation.fields.realEstateType')} *</FormLabel>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                							<FormLabel>{t('propertyCreation.fields.description')} *</FormLabel>
                                                <FormControl>
                                ...
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.landSize')} (m<sup>2</sup>)</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.marketPrice')}</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.yearBuilt')}</FormLabel>
                                                <FormControl>
                            ...
                            <CardContent>
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.street')}</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.zip')}</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.city')}</FormLabel>
                                                <FormControl>
                                ...
                                <FormGroup useFlex>
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.state')}</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem >
                                                							<FormLabel>{t('propertyCreation.fields.country')}</FormLabel>
                                                <FormControl>
                        ...
                        <Card >
                            ...
                            <CardContent className="flex flex-col gap-4">
                                <FormItem >
                                    <FormLabel>{t('propertyCreation.fields.imageUrl')}</FormLabel>
                            ...
                            unitMultiplicity === "single" ? (
                                <div className="flex flex-col gap-4">
                                    <Card>
                                        <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                                            							<Info/>
							{t('propertyCreation.sections.units')}
                                        </CardHeader>
                                        <CardContent>
                                            <FormGroup useFlex>
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.unitNumber')}</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.floor')}</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.unitSize')}</FormLabel>
                                                            <FormControl>
                                            ...
                                            <FormGroup useFlex>
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.rentalPrice')}</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.status')}</FormLabel>
                                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                                <FormControl>
                                                                    <SelectTrigger>
                                                                        <SelectValue placeholder="Select..." />
                                        ...
                                        <CardContent>
                                            <FormGroup useFlex>
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.numOfFloors')}</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.numOfRooms')}</FormLabel>
                                                            <FormControl>
                                            ...
                                            <FormGroup useFlex>
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.numOfBedrooms')}</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.numOfBathrooms')}</FormLabel>
                                                            <FormControl>
                                                                <Input placeholder="2" type="number" {...field} />
                                                            </FormControl>
                                                            <FormMessage/>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({field}) => (
                                                        <FormItem >
                                                            							<FormLabel>{t('propertyCreation.fields.garages')}</FormLabel>
                                                            <FormControl>
                                                                <Input placeholder="2" type="number" {...field} />
                                                            </FormControl>
                                                            <FormMessage/>
            ...
            <div
                ...
                <Card>
                    <CardHeader className="border-b-2 text-lg font-500 border-border p-4 flex flex-row items-center gap-2">
                        						<BadgeCheck/>
						{t('propertyCreation.sections.confirmation')}
                    </CardHeader>
